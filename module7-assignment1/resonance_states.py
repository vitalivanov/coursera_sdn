...
class LBStateMachine(ResonanceStateMachine):
    ...
    def get_portA_hosts(self):
        return self.get_hosts_in_state('portA') # hint: use the get_hosts_in_state function

    def get_portB_hosts(self):
        return self.get_hosts_in_state('portB') # hint: use the get_hosts_in_state function
